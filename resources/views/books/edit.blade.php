    ...
    <form action="{{ route('books.update', $book) }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input type="number" id="bookYear" name="book[year]"
            class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" min="0" required
            value="{{ old('book.year', $book->year) }}">
        </div>

        <div>
          <label for="bookISBN" class="block text-sm font-semibold mb-1">ISBN</label>
          <input type="text" id="bookISBN" name="book[isbn]"
            class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required
        ...
        <div>
          ...
          <input type="text" id="bookEdition" name="book[edition]"
            class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required
        ...
        <div>
          ...
          <input type="text" id="bookPublisher" name="book[publisher]"
            class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required
        ...
        <div>
          ...
          <input type="text" id="bookShelf" name="book[shelf_location]"
            class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required
        ...
        <div>
          ...
          <input type="number" id="bookQuantity" name="book[quantity]" min="1"
            class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required
