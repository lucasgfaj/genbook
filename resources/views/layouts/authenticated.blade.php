...
@section('title', 'GenBook') <!-- Título da página -->

@section('body-class', 'bg-[#F9FAFB] text-gray-900 font-sans antialiased')
    ...
    <aside class="w-64 bg-[#1E40AF] text-white flex flex-col px-4 py-6 fixed h-full overflow-y-auto">
        ...
        <nav class="flex-1">
            <ul class="space-y-1">
                ...
                <li><a href="/categories" class="flex items-center px-3 py-2 rounded-md hover:bg-[#3B82F6] text-white">
...
@endsection
 ...
 @push('scripts')
    @vite(['resources/js/authenticated.js', 'resources/js/loading.js'])
@endpush